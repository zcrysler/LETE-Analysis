...
tmp <- tmp %>% as.data.frame(tmp) %>% arrange(motusTagID)
kable(tmp, booktabs = TRUE, caption = 'Incubation detection period for all tags') 
```
...
# signal strength below 80 at Exxon Fields (see results), thus foraging will be:
