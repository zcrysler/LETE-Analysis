...
The following table lists the latitude and longitude for each pair of receivers (X and Y), and distance (m) between them:
...
param.table <- rename(param.table, "Receiver X" = recvDeployName1, 
                      "Receiver Y" = recvDeployName2, "Distance (m)" = distance)
knitr::kable(select(param.table, "Receiver X", "Receiver Y", "Location X", "Location Y", "Distance (m)"), 
